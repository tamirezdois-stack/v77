...
def create_app():
    ...
    from routes.document_analysis import document_analysis_bp
    ...
    app.register_blueprint(document_analysis_bp, url_prefix='/api/document_analysis')

    @app.route('/')
    def index():
        """Página principal"""
        return render_template('enhanced_interface_v4.html')
    ...
    @app.route('/v4')
    def interface_v4():
        """Interface v4.0 com análise de documentos"""
        return render_template('enhanced_interface_v4.html')
