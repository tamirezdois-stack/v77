...
def create_app():
    ...
    # Importa rotas de autenticação Google
    try:
        from routes.google_auth import register_google_auth_routes
        HAS_GOOGLE_AUTH_ROUTES = True
    except ImportError:
        HAS_GOOGLE_AUTH_ROUTES = False
    ...
    # Registra rotas de autenticação Google se disponível
    if HAS_GOOGLE_AUTH_ROUTES:
